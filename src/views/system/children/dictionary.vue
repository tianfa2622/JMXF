<template>
  <div class="system_content">
    ...
    <el-dialog :title="deltitle" :visible.sync="delShow" center width="30%">
      <p v-if="deltitle === '删除'">确认删除该字典吗？<br /></p>
      <p v-else>确认要禁用该字典吗？</p>
      <template #footer>
        <span class="dialog-footer">
  ...
  data() {
    return {
      ...
      searchSettings: [
        ...
        { placeholder: '请输入字典编码或名称', type: 'input', name: 'input' }
      ],
      // 弹出框
      dialogSettings: [
        {
        ...
        { label: '字典编号', placeholder: '请输入字典编号', type: 'input', name: 'input' },
        { label: '字典名称', placeholder: '请输入字典名称', type: 'input', name: 'input' }
      ],
      // 搜索组件按钮属性
      searchBtn: [
        { name: '查询', type: 'search' },
