<template>
  <div class="ForceDeployment">
    <div class="row-content">
      <div class="col-search">
        <Elsearch :search-settings="searchSettings" :search-btn="searchBtn" :form-data="formData" @derived="derived" @search="search" @reset="reset" />
      </div>
      <div class="col-table">
    ...
    <el-dialog :title="title" :modal-append-to-body="false" :visible.sync="dialogShow" center width="60%">
      <Deploy />
      <template #footer>
    ...
    <el-dialog title="删除" :modal-append-to-body="false" :visible.sync="delShow" center width="30%">
...
export default {
  components: { Elsearch, Tablein, Deploy },
  data() {
    return {
      disable: false, // 输入框只读
      title: '', // 弹出框标题
